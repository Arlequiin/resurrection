...
#define MAP_PROTASHOUSE                          (5 | (1 << 8))
#define MAP_PROTASROOM                           (6 | (1 << 8))
#define MAP_PASSAGE                              (7 | (1 << 8))
...
#define MAP_HALL_GARE                     (5 | (2 << 8))
#define MAP_TRAIN                         (6 | (2 << 8))
...
#define MAP_TEMPLE_FORESTIER                       (8 | (5 << 8))
