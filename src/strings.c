...
const u8 gText_EVO_FRIENDSHIP[]                     = _("Nv+1, high friendship");
const u8 gText_EVO_FRIENDSHIP_DAY[]                 = _("Nv+1, high friendship, day");
const u8 gText_EVO_FRIENDSHIP_NIGHT[]               = _("Nv+1, high friendship, night");
const u8 gText_EVO_LEVEL[]                          = _("Nv+1 to {STR_VAR_2}");
...
const u8 gText_EVO_LEVEL_NINJASK[]                  = _("Nv+1 to {STR_VAR_2}");
const u8 gText_EVO_LEVEL_SHEDINJA[]                 = _("Nv+1 en {STR_VAR_2}, party<6, 1x POKéBALL");
const u8 gText_EVO_BEAUTY[]                         = _("Nv+1, high beauty");
const u8 gText_EVO_LEVEL_FEMALE[]                   = _("Nv+1 en {STR_VAR_2}, is female");
const u8 gText_EVO_LEVEL_MALE[]                     = _("Nv+1 en {STR_VAR_2}, is male");
const u8 gText_EVO_LEVEL_NIGHT[]                    = _("Nv+1 en {STR_VAR_2}, night");
const u8 gText_EVO_LEVEL_DAY[]                      = _("Nv+1 en {STR_VAR_2}, day");
const u8 gText_EVO_LEVEL_DUSK[]                     = _("Nv+1 en {STR_VAR_2}, dusk (5-6PM)");
const u8 gText_EVO_ITEM_HOLD_DAY[]                  = _("Nv+1, holds {STR_VAR_2}, day");
const u8 gText_EVO_ITEM_HOLD_NIGHT[]                = _("Nv+1, holds {STR_VAR_2}, night");
const u8 gText_EVO_MOVE[]                           = _("Nv+1, knows {STR_VAR_2}");
const u8 gText_EVO_MOVE_TYPE[]                      = _("Nv+1, knows {STR_VAR_2} move");
const u8 gText_EVO_MAPSEC[]                         = _("Nv+1 on {STR_VAR_2}");
const u8 gText_EVO_ITEM_MALE[]                      = _("{STR_VAR_2} used on male");
const u8 gText_EVO_ITEM_FEMALE[]                    = _("{STR_VAR_2} used on female");
const u8 gText_EVO_LEVEL_RAIN[]                     = _("Nv+1 to {STR_VAR_2} while raining");
const u8 gText_EVO_SPECIFIC_MON_IN_PARTY[]          = _("Nv+1 with {STR_VAR_2} in party");
const u8 gText_EVO_LEVEL_DARK_TYPE_MON_IN_PARTY[]   = _("Nv+1 with dark type in party");
const u8 gText_EVO_TRADE_SPECIFIC_MON[]             = _("Traded for {STR_VAR_2}");
const u8 gText_EVO_SPECIFIC_MAP[]                   = _("Nv+1 on {STR_VAR_2}");
