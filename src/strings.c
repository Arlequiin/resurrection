...
const u8 gText_ExpandedPlaceholder_May[] = _("Midori");
...
const u8 gText_MenuOptionPokenav[] = _("V.N Tech");
...
const u8 gText_PokenavAndBag[] = _("V.N Tech ET SAC");
...
const u8 gText_PutAwayPokenav[] = _("Ranger le V.N Tech.");
...
const u8 gText_ReturnToPokenavMenu[] = _("Retour au menu V.N Tech.");
...
const u8 gText_KissPoster16BP[] = _("POSTER BAISER{CLEAR_TO 94}16PCo");
const u8 gText_KissCushion32BP[] = _("COUSSIN BAISER{CLEAR_TO 94}32PCo");
const u8 gText_SmoochumDoll32BP[] = _("POUPEE LIPPOUTI{CLEAR_TO 94}32PCo");
const u8 gText_TogepiDoll48BP[] = _("POUPEE TOGEPI{CLEAR_TO 94}48PCo");
const u8 gText_MeowthDoll48BP[] = _("POUPEE MIAOUSS{CLEAR_TO 94}48PCo");
const u8 gText_ClefairyDoll48BP[] = _("POUPEE MELOFEE{CLEAR_TO 94}48PCo");
const u8 gText_DittoDoll48BP[] = _("POUP. METAMORPH{CLEAR_TO 94}48PCo");
const u8 gText_CyndaquilDoll80BP[] = _("POUP.HERICENDRE{CLEAR_TO 94}80PCo");
const u8 gText_ChikoritaDoll80BP[] = _("POUP. GERMIGNON{CLEAR_TO 94}80PCo");
const u8 gText_TotodileDoll80BP[] = _("POUPEE KAIMINUS{CLEAR_TO 94}80PCo");
const u8 gText_LaprasDoll128BP[] = _("POUPEE LOKHLASS{CLEAR_TO 96}128PCo");
const u8 gText_SnorlaxDoll128BP[] = _("POUPEE RONFLEX{CLEAR_TO 96}128PCo");
const u8 gText_VenusaurDoll256BP[] = _("POUP.FLORIZARRE{CLEAR_TO 96}256PCo");
const u8 gText_CharizardDoll256BP[] = _("POUP. DRACAUFEU{CLEAR_TO 96}256PCo");
const u8 gText_BlastoiseDoll256BP[] = _("POUPEE TORTANK{CLEAR_TO 96}256PCo");
const u8 gText_Protein1BP[] = _("PROTEINE{CLEAR_TO 100}1PCo");
const u8 gText_Calcium1BP[] = _("CALCIUM{CLEAR_TO 100}1PCo");
const u8 gText_Iron1BP[] = _("FER{CLEAR_TO 100}1PCo");
const u8 gText_Zinc1BP[] = _("ZINC{CLEAR_TO 100}1PCo");
const u8 gText_Carbos1BP[] = _("CARBONE{CLEAR_TO 100}1PCo");
const u8 gText_HpUp1BP[] = _("PV PLUS{CLEAR_TO 100}1PCo");
const u8 gText_Leftovers48BP[] = _("RESTES{CLEAR_TO 94}48PCo");
const u8 gText_WhiteHerb48BP[] = _("HERBEBLANCHE{CLEAR_TO 94}48PCo");
const u8 gText_QuickClaw48BP[] = _("VIVE GRIFFE{CLEAR_TO 94}48PCo");
const u8 gText_MentalHerb48BP[] = _("HERBE MENTAL{CLEAR_TO 94}48PCo");
const u8 gText_BrightPowder64BP[] = _("POUDRECLAIRE{CLEAR_TO 94}64PCo");
const u8 gText_ChoiceBand64BP[] = _("BAND. CHOIX{CLEAR_TO 94}64PCo");
const u8 gText_KingsRock64BP[] = _("ROCHE ROYALE{CLEAR_TO 94}64PCo");
const u8 gText_FocusBand64BP[] = _("BANDEAU{CLEAR_TO 94}64PCo");
const u8 gText_ScopeLens64BP[] = _("LENTILSCOPE{CLEAR_TO 94}64PCo");
const u8 gText_Softboiled16BP[] = _("E-COQUE{CLEAR_TO 78}16PCo");
const u8 gText_SeismicToss24BP[] = _("FRAPPE ATLAS{CLEAR_TO 78}24PCo");
const u8 gText_DreamEater24BP[] = _("DEVOREVE{CLEAR_TO 78}24PCo");
const u8 gText_MegaPunch24BP[] = _("ULTIMAPOING{CLEAR_TO 78}24PCo");
const u8 gText_MegaKick48BP[] = _("ULTIMAWASHI{CLEAR_TO 78}48PCo");
const u8 gText_BodySlam48BP[] = _("PLAQUAGE{CLEAR_TO 78}48PCo");
const u8 gText_RockSlide48BP[] = _("EBOULEMENT{CLEAR_TO 78}48PCo");
const u8 gText_Counter48BP[] = _("RIPOSTE{CLEAR_TO 78}48PCo");
const u8 gText_ThunderWave48BP[] = _("CAGE-ECLAIR{CLEAR_TO 78}48PCo");
const u8 gText_SwordsDance48BP[] = _("DANSE-LAMES{CLEAR_TO 78}48PCo");
const u8 gText_DefenseCurl16BP[] = _("BOUL’ARMURE{CLEAR_TO 78}16PCo");
const u8 gText_Snore24BP[] = _("RONFLEMENT{CLEAR_TO 78}24PCo");
const u8 gText_MudSlap24BP[] = _("COUD’BOUE{CLEAR_TO 78}24PCo");
const u8 gText_Swift24BP[] = _("METEORES{CLEAR_TO 78}24PCo");
const u8 gText_IcyWind24BP[] = _("VENT GLACE{CLEAR_TO 78}24PCo");
const u8 gText_Endure48BP[] = _("TENACITE{CLEAR_TO 78}48PCo");
const u8 gText_PsychUp48BP[] = _("BOOST{CLEAR_TO 78}48PCo");
const u8 gText_IcePunch48BP[] = _("POINGLACE{CLEAR_TO 78}48PCo");
const u8 gText_ThunderPunch48BP[] = _("POING-ECLAIR{CLEAR_TO 78}48PCo");
const u8 gText_FirePunch48BP[] = _("POING DE FEU{CLEAR_TO 78}48PCo");
...
const u8 gText_Peekaboo[] = _("AAAAAAAAAA");
...
const u8 gText_TellHimTheWords[] = _("Saisir un code");
...
const u8 gText_MrStoneMatchCallDesc[] = _("Employé V.N");
const u8 gText_MrStoneMatchCallName[] = _("M. Keth");
const u8 gText_StevenMatchCallDesc[] = _("COMME UN ROC");
const u8 gText_StevenMatchCallName[] = _("PIERRE");
const u8 gText_MayBrendanMatchCallDesc[] = _("Boursier");
const u8 gText_NormanMatchCallDesc[] = _("SERIEUX");
const u8 gText_MomMatchCallDesc[] = _("LA PLUS DOUCE");
const u8 gText_WallyMatchCallDesc[] = _("Boursière");
...
const u8 gText_Hoenn2[] = _("Hoenn");
const u8 gText_Sinnoh[] = _("Sinnoh");
const u8 gText_Unys[] = _("Unys");
const u8 gText_Kalos[] = _("Kalos");
const u8 gText_Alola[] = _("Alola");
const u8 gText_Galar[] = _("Galar");
const u8 gText_Grass[] = _("Plante");
const u8 gText_Fire[] = _("Feu");
const u8 gText_Water[] = _("Eau");
const u8 gText_Alea[] = _("Aléatoire");


//HGSS_Ui PokedexPlus
const u8 gText_Stats_Buttons[]  = _("{A_BUTTON}TOGGLE   {DPAD_UPDOWN}Attaq.");
const u8 gText_Stats_Buttons_Decapped[]  = _("{A_BUTTON}Toggle   {DPAD_UPDOWN}Attaq.");
...
const u8 gText_Stats_CatchRate[]     = _("CAPT.{0x5B}: ");
const u8 gText_Stats_CatchRate_Legend[]         = _("LEGENDAIRE");
const u8 gText_Stats_CatchRate_VeryHard[]       = _("Très dur");
const u8 gText_Stats_CatchRate_Difficult[]      = _("Dur");
const u8 gText_Stats_CatchRate_Medium[]         = _("Moyen");
const u8 gText_Stats_CatchRate_Relaxed[]        = _("Normal");
const u8 gText_Stats_CatchRate_Easy[]           = _("Facile");
const u8 gText_Stats_ExpYield[]      = _("Gain XP: ");
const u8 gText_Stats_EggCycles[]     = _("Pas éclos.:");
...
const u8 gText_Stats_MEDIUM_FAST[]   = _("Moy. Rapide");
const u8 gText_Stats_ERRATIC[]       = _("Érratique");
...
const u8 gText_Stats_eggGroup[]             = _("Œufs G1:");
const u8 gText_Stats_eggGroup_Groups[]      = _("{STR_VAR_1}/{STR_VAR_2}");
const u8 gText_Stats_eggGroup_MONSTER[]     = _("Monstrueux");
const u8 gText_Stats_eggGroup_WATER_1[]     = _("Aqua. {CIRCLE_1}");
const u8 gText_Stats_eggGroup_BUG[]         = _("Insectoïde");
const u8 gText_Stats_eggGroup_FLYING[]      = _("Aérien");
const u8 gText_Stats_eggGroup_FIELD[]       = _("Terrestre");
const u8 gText_Stats_eggGroup_FAIRY[]       = _("Féerique");
const u8 gText_Stats_eggGroup_GRASS[]       = _("Végétal");
const u8 gText_Stats_eggGroup_HUMAN_LIKE[]  = _("Humanoïde");
const u8 gText_Stats_eggGroup_WATER_3[]     = _("Aqua. {CIRCLE_3}");
const u8 gText_Stats_eggGroup_MINERAL[]     = _("Minéral");
const u8 gText_Stats_eggGroup_AMORPHOUS[]   = _("Amorphe");
const u8 gText_Stats_eggGroup_WATER_2[]     = _("Aqua. {CIRCLE_2}");
const u8 gText_Stats_eggGroup_DITTO[]       = _("Métamorph");
const u8 gText_Stats_eggGroup_DRAGON[]      = _("Draconique");
const u8 gText_Stats_eggGroup_UNDISCOVERED[]= _("---");
const u8 gText_Dex_SEEN[]   = _("Vu");
const u8 gText_Dex_OWN[]    = _("Capturé");
...
const u8 gText_EVO_Buttons_Decapped_PE[]            = _("{DPAD_UPDOWN}Évos  {A_BUTTON}Check  {START_BUTTON} formes");
const u8 gText_EVO_Name[]                           = _("{STR_VAR_3}:");
const u8 gText_EVO_PreEvo[]                         = _("{STR_VAR_1} est l'évolution de {STR_VAR_2}");
const u8 gText_EVO_PreEvo_PE_Mega[]                 = _("{STR_VAR_1} méga-évolue en {STR_VAR_2}");
const u8 gText_EVO_FRIENDSHIP[]                     = _("Nv+1, bonheur");
const u8 gText_EVO_FRIENDSHIP_DAY[]                 = _("Nv+1, bonheur, jour");
const u8 gText_EVO_FRIENDSHIP_NIGHT[]               = _("Nv+1, bonheur, nuit");
const u8 gText_EVO_LEVEL[]                          = _("Nv+1 à  {STR_VAR_2}");
...
const u8 gText_EVO_LEVEL_ATK_GT_DEF[]               = _("Nv+1 en {STR_VAR_2}, Atk > Def");
const u8 gText_EVO_LEVEL_ATK_EQ_DEF[]               = _("Nv+1 en {STR_VAR_2}, Atk = Def");
const u8 gText_EVO_LEVEL_ATK_LT_DEF[]               = _("Nv+1 en {STR_VAR_2}, Atk < Def");
const u8 gText_EVO_LEVEL_SILCOON[]                  = _("Nv+1 en {STR_VAR_2}, Silcoon persona");
const u8 gText_EVO_LEVEL_CASCOON[]                  = _("Nv+1 en {STR_VAR_2}, Cascoon persona");
const u8 gText_EVO_LEVEL_NINJASK[]                  = _("Nv+1 à  {STR_VAR_2}");
const u8 gText_EVO_LEVEL_SHEDINJA[]                 = _("Nv+1 en {STR_VAR_2}, équipe<6, 1x POKéBALL");
const u8 gText_EVO_BEAUTY[]                         = _("Nv+1, high beauty");
const u8 gText_EVO_LEVEL_FEMALE[]                   = _("Nv+1 en {STR_VAR_2}, femelle");
const u8 gText_EVO_LEVEL_MALE[]                     = _("Nv+1 en {STR_VAR_2}, mâle");
const u8 gText_EVO_LEVEL_NIGHT[]                    = _("Nv+1 en {STR_VAR_2}, nuit");
const u8 gText_EVO_LEVEL_DAY[]                      = _("Nv+1 en {STR_VAR_2}, jour");
const u8 gText_EVO_LEVEL_DUSK[]                     = _("Nv+1 en {STR_VAR_2}, aurore (5-6PM)");
const u8 gText_EVO_ITEM_HOLD_DAY[]                  = _("Nv+1, tient {STR_VAR_2}, jour");
const u8 gText_EVO_ITEM_HOLD_NIGHT[]                = _("Nv+1, tient {STR_VAR_2}, nuit");
const u8 gText_EVO_MOVE[]                           = _("Nv+1, connaît {STR_VAR_2}");
const u8 gText_EVO_MOVE_TYPE[]                      = _("Nv+1, connaît {STR_VAR_2}");
const u8 gText_EVO_MAPSEC[]                         = _("Nv+1 à {STR_VAR_2}");
const u8 gText_EVO_ITEM_MALE[]                      = _("{STR_VAR_2} sur un mâle");
const u8 gText_EVO_ITEM_FEMALE[]                    = _("{STR_VAR_2} sur une femelle");
const u8 gText_EVO_LEVEL_RAIN[]                     = _("Nv+1 à  {STR_VAR_2} sous pluie");
const u8 gText_EVO_SPECIFIC_MON_IN_PARTY[]          = _("Nv+1 with {STR_VAR_2} in party");
const u8 gText_EVO_LEVEL_DARK_TYPE_MON_IN_PARTY[]   = _("Nv+1 avec Type Ténèbr");
const u8 gText_EVO_TRADE_SPECIFIC_MON[]             = _("Échangé contre {STR_VAR_2}");
const u8 gText_EVO_SPECIFIC_MAP[]                   = _("Nv+1 à {STR_VAR_2}");
const u8 gText_EVO_UNKNOWN[]                        = _("Méthode inconnue.");
const u8 gText_EVO_NONE[]                           = _("{STR_VAR_1} n'évolue pas.");

const u8 gText_FORMS_Buttons_PE[]                   = _("{A_BUTTON}Formes  {START_BUTTON}Évos");
const u8 gText_FORMS_Buttons_Decapped_PE[]          = _("{START_BUTTON}Évos");
const u8 gText_FORMS_Buttons_Submenu_PE[]           = _("{DPAD_NONE}FORMs {A_BUTTON}CHECK {START_BUTTON}Évos");
const u8 gText_FORMS_Buttons_Submenu_Decapped_PE[]  = _("{START_BUTTON}Évos");
const u8 gText_FORMS_NONE[]                         = _("{STR_VAR_1} n'a pas de forme alternative.");
