...
const struct Tileset gTileset_Mirabilis =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Mirabilis,
    .palettes = gTilesetPalettes_Mirabilis,
    .metatiles = gMetatiles_Mirabilis,
    .metatileAttributes = gMetatileAttributes_Mirabilis,
    .callback = InitTilesetAnim_Mirabilis,
};
...
const struct Tileset gTileset_IndoorCdr =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_IndoorCdr,
    .palettes = gTilesetPalettes_IndoorCdr,
    .metatiles = gMetatiles_IndoorCdr,
    .metatileAttributes = gMetatileAttributes_IndoorCdr,
    .callback = InitTilesetAnim_IndoorCdr,
};

const struct Tileset gTileset_Gare =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Gare,
    .palettes = gTilesetPalettes_Gare,
    .metatiles = gMetatiles_Gare,
    .metatileAttributes = gMetatileAttributes_Gare,
...
const struct Tileset gTileset_Train =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Train,
    .palettes = gTilesetPalettes_Train,
    .metatiles = gMetatiles_Train,
    .metatileAttributes = gMetatileAttributes_Train,
