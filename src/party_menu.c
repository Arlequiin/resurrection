...
{
    static const u8 askText[] = _("Voulez vous que {STR_VAR_1}\nobtienne le talent {STR_VAR_2}?");
    static const u8 doneText[] = _("Le talent de {STR_VAR_1}\n est devenu{STR_VAR_2}!{PAUSE_UNTIL_PRESS}");
    s16 *data = gTasks[taskId].data;
